...
Re-run on the head rebased onto `8132a67f`, one process at a time. The pool is
the set that has to be good, and `test:procgen`'s five seeds are not it.

| seed | time | attractions routed | waypoints connected | |
|---|---|---|---|---|
| 0 | 11 s | 19/19 | 250/250 | ok |
| 1 | 6 s | 19/19 | 229/229 | ok |
| 2 | 10 s | 19/19 | 231/231 | ok |
| 3 | 50 s | 19/19 | 240/240 | ok |
| 4 | 46 s | 19/19 | 260/260 | ok |
| 5 | 14 s | 19/19 | 236/236 | ok |
| 6 | 7 s | 19/19 | 241/241 | ok |
| 7 | 237 s | 19/19 | 263/263 | ok |
| 8 | 11 s | 19/19 | 295/295 | ok |
| 9 | 7 s | 19/19 | 242/242 | ok |
| 10 | 9 s | 19/19 | 262/262 | ok |
| 11 | 5 s | 19/19 | 314/314 | ok |
| 12 | 7 s | 19/19 | 288/288 | ok |
| 13 | 5 s | 19/19 | 251/251 | ok |
| 14 | 9 s | 19/19 | 216/216 | ok |
| 15 | 32 s | 19/19 | 268/268 | ok |

**16 of 16 exit 0**, 19/19 attractions routed from the entrance on every seed,
**every waypoint connected on every seed**, all six of `check:park`'s own
invariants holding throughout. Nothing was stranded by the path-graph,
slide-route or castle-frame changes; the 5x-larger slide search landed no seed
on a route that breaks the park; and the rebase onto #670's re-solved park did
not disturb it.
