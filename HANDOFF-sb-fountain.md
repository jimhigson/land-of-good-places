...
Verified: check:nav-routes exit 0; park:attempt 20260728 r0 and 2 r0 accepted, output identical to pre-fix (minus timings). tsc both projects exit 0. Snapshot worktree removed.
