...
| 78 | the Sky Cruiser always flies through the castle | skyCruiserAlwaysFliesThroughTheCastle (5757) | cruiser (cruiserRouteSearch, src/world/coaster/route.ts:1142) | yes: `satisfies: crossesTheCastle` route.ts:1047/352 plus escalated re-solve ~1051 (plan-space span; built span re-derived at route.ts:1425) | cruiser builder already; could also assert on built castleSpan in finishCruiserPlanSearch |
