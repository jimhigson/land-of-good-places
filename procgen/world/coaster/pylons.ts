...
import { type RailSampler } from '../../../src/world/rail/sweptRail';
...
import { POST_FOOT_RADIUS } from '../../../src/world/railRace/trestleGeometry';
import { PATH_CLEARANCE, type CruiserPylon } from '../../../src/world/coaster/pylons';
/**
 * **Where the Sky Cruiser's pylons stand** — a slot pass and a gap-filling pass
 * along the loop. Moved verbatim from `src/world/coaster/pylons.ts`; the game
 * reads the chosen pylons from the park file. Build-time only.
 */
