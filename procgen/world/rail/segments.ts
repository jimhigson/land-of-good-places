...
import { cubicPoint, cubicTangent, type Biarc, type CubicSegment, type Pose2, type SegmentKind, type Vec2 } from '../../../src/world/rail/segments';
/**
 * **The track-piece vocabulary the rail search grows routes from.** Moved
 * verbatim from `src/world/rail/segments.ts`, which keeps the segment types
 * and the cubic evaluators a built route needs. Build-time only.
 */
