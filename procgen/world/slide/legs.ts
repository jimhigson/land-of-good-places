...
import { carSweepsColumn, cruiserCrossesColumn, insideCastle } from '../../../src/world/slide/planned';
import { distanceToPath } from '../../../src/world/pathGraph';
import { PARK_LAYOUT } from '../../../src/world/parkLayout';
import { FOOT_RADIUS, type SlideLeg } from '../../../src/world/slide/supports';
/**
 * **Where the slide's legs stand** — a sparse search along the chute for clear
 * ground. Moved verbatim from `src/world/slide/supports.ts`, which builds the
 * legs the park file names. Build-time only.
 */
