import { STALL_LAYOUT_IDS, STALL_PLACEMENTS, STALL_STAND_DISTANCE, clearStallShifts, setStallShift, stallShift, type StallPlacement } from '../../src/minigames/stallPlacement';
import { shapesOverlap, type Claim, type GroundClaims } from '../../src/boot/groundClaims';
import { boothBoxFor, boothClaims, type BoothBox } from '../../src/minigames/boothFootprint';
...
/**
 * **The stalls' builder** — which booths stand, and where one steps aside to.
 * Moved verbatim from `src/world/stallsFeature.ts`, which keeps the booth
 * relocation types. Build-time only.
 */
