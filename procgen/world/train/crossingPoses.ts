import { type Pose2 } from '../../../src/world/rail/segments';
import { ENTRANCE_GATE_X, ENTRANCE_GATE_Z } from '../../../src/world/entrance/layout';
import { GARDEN_PLAY_BOUNDARY } from '../../../src/world/boundary';
import { NARROW_HALF_WIDTH, SITE_BOUNDARY_MARGIN, SITE_HALF_WIDTH, SITE_PLOT_MARGIN, SITE_RAMP_FLOOR, SITE_RAMP_IDEAL } from '../../../src/world/train/bridgeFit';
import { probeBridgeReach } from './bridgeFit';
import { Rng } from '../../../src/core/mathUtils';
/**
 * **Bridgeable crossing poses** for the railway loop's search. Moved verbatim
 * from `src/world/train/crossingPoses.ts`. Build-time only.
 */
