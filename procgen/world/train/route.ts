...
import { RAIL_OVER_RAIL_AIR } from '../../../src/world/coaster/route';
...
import { bridgeableCrossingPosesSearch } from '../../../src/world/train/crossingPoses';
import { PARK_SEED } from '../../../src/world/parkManifest';
import { type RouteBrief, type SolvedRailRoute } from '../../../src/world/rail/generate';
import { SITE_RAMP_FLOOR, fitBridgeAcross, railCorridorBlocked } from '../../../src/world/train/bridgeFit';
import { chosenCrossingCorridor, crossingSurvivesStationAt } from '../../../src/world/train/crossingKeepOut';
...
/**
 * **The railway loop's search.** Moved verbatim from `src/world/train/route.ts`,
 * which keeps `TrainRoute` (built from the decided loop). Build-time only
