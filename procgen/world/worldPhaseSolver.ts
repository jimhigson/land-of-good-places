...
import { bushBuilder, treeBuilder, wallBuilder, type BushDecision, type TreeDecision, type WallRun } from '../../src/world/Scenery';
import { lampBuilder, type LampDecision } from '../../src/world/LampPosts';
import { fairyPoleBuilder, type FairyChain } from '../../src/world/FairyLights';
import { stallBuilder, type BoothRelocator } from '../../src/world/stallsFeature';
